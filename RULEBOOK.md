...
The coach gives a score out of 10, XP earned, and concise feedback.

Feedback identifies what was strong and what is missing without immediately giving the ideal answer.

The player may make one coached retry.

If the retry improves the answer, the higher score replaces the original score and only the additional XP is added.

No additional Gold is awarded for the retry.

After the retry, or when the player accepts the result, the coach may give the full learning reveal.
